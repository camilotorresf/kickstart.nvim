...
----------------------------------------
-- bufferline
vim.keymap.set('n', '<leader>b1', 'require("bufferline").go_to(1, true)<cr>', { desc = 'Absolute Buffer 1' })
vim.keymap.set('n', '<leader>b1', 'require("bufferline").go_to(1, true)<cr>', { desc = 'Absolute Buffer 1' })
vim.keymap.set('n', '<leader>b2', 'require("bufferline").go_to(2, true)<cr>', { desc = 'Absolute Buffer 2' })
vim.keymap.set('n', '<leader>b3', 'require("bufferline").go_to(3, true)<cr>', { desc = 'Absolute Buffer 3' })
vim.keymap.set('n', '<leader>b4', 'require("bufferline").go_to(4, true)<cr>', { desc = 'Absolute Buffer 4' })
vim.keymap.set('n', '<leader>b5', 'require("bufferline").go_to(5, true)<cr>', { desc = 'Absolute Buffer 5' })
vim.keymap.set('n', '<leader>b6', 'require("bufferline").go_to(6, true)<cr>', { desc = 'Absolute Buffer 6' })
vim.keymap.set('n', '<leader>b7', 'require("bufferline").go_to(7, true)<cr>', { desc = 'Absolute Buffer 7' })
vim.keymap.set('n', '<leader>b8', 'require("bufferline").go_to(8, true)<cr>', { desc = 'Absolute Buffer 8' })
vim.keymap.set('n', '<leader>b9', 'require("bufferline").go_to(9, true)<cr>', { desc = 'Absolute Buffer 9' })
vim.keymap.set('n', '<leader>b0', 'require("bufferline").go_to(-1, true)<cr>', { desc = 'Last Buffer' })
